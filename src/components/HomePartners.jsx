    ...
    <Grid container spacing={4} justifyContent="center" alignItems="center">
      {partners.map((p, idx) => (
        <Grid item xs={12} sm={4} md={3} key={idx}>
          <Paper sx={{ p: 3, borderRadius: 2, boxShadow: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', height: 120, justifyContent: 'center' }}>
            <img src={p.logo} alt={p.name} style={{ maxHeight: 60, maxWidth: '100%', marginBottom: 8 }} />
